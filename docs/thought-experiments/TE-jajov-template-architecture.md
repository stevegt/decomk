# TE-jajov: Thought Experiment: Init template architecture split

- **TE ID:** `TE-jajov`
- **Decision under test:** How many devcontainer templates should be maintained for init + examples.
- **Related TODO:** `TODO/TODO-danih-consumer-init-minimal-template-and-image-source.md`
...
3. **Three templates**
   - Producer full template + consumer minimal template + examples/selftest full template (chosen architecture record for TODO-danih).
...
Surviving alternative for TODO-danih lock: **Three-template model**.
