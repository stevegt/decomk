# TODO-dahuk: phase-eval: empirical lifecycle spike for devcontainer/DevPod/Codespaces
...
Affects: `examples/phase-eval/run.sh`, `TODO/TODO-dahuk-phase-eval-lifecycle-spike.md`.
...
Affects: `examples/phase-eval/run.sh`, `examples/phase-eval/README.md`, `TODO/TODO-dahuk-phase-eval-lifecycle-spike.md`.
...
Status: active
Decision: Cross-link phase-eval findings to the deferred self-hosting runtime-adaptation decision tracked in TODO-fuviv.14.
...
Constraints: Keep TODO-dahuk focused on evidence collection; keep runtime-adaptation implementation work deferred to TODO-fuviv.
Affects: `TODO/TODO-dahuk-phase-eval-lifecycle-spike.md`, `TODO/TODO-fuviv-devpod-gcp-selfhost-migration.md`.
...
Affects: `examples/phase-eval/hook_probe.sh`, `examples/phase-eval/run.sh`, `examples/phase-eval/README.md`, `TODO/TODO-dahuk-phase-eval-lifecycle-spike.md`.
...
Affects: `TODO/TODO-dahuk-phase-eval-lifecycle-spike.md`, `TODO/TODO-jirin-decomk-devcontainer-tool-bootstrap.md`, `TODO/TODO-bitum-decomk-user-customization-via-github-user.md`.
...
Affects: `.devcontainer/phase-eval/devcontainer.json`, `examples/phase-eval/run.sh`, `examples/phase-eval/README.md`, `TODO/TODO-dahuk-phase-eval-lifecycle-spike.md`.
...
Affects: `examples/phase-eval/run.sh`, `examples/phase-eval/hook_probe.sh`, `examples/phase-eval/README.md`, `TODO/TODO-dahuk-phase-eval-lifecycle-spike.md`.

ID: DI-fitis
Date: 2026-04-19 10:09:00
Status: active
Decision: Promote `/tmp/decomk-phase-eval.20260419T014758Z-3468588/summary.json` as canonical lifecycle evidence and update TODO-dahuk conclusions to include `onCreate` coverage plus dual identity signals (`GITHUB_USER`, `USER`) per phase/platform.
...
Affects: `TODO/TODO-dahuk-phase-eval-lifecycle-spike.md`.
Supersedes: DI-jahoj
...
- Implementing runtime-adaptation/fork work for hook-inclusive self-hosted prebuilds (tracked as `TODO-fuviv.14`).

## Subtasks

- [x] dahuk.1 Add `examples/phase-eval/run.sh` orchestrator with explicit rc/stdout/stderr capture.
- [x] dahuk.2 Add `examples/phase-eval/hook_probe.sh` lifecycle probe script for hook markers + env snapshots.
- [x] dahuk.3 Add `examples/phase-eval/lib.sh` shared helpers and no-silent-failure utilities.
- [x] dahuk.4 Add `.devcontainer/phase-eval/devcontainer.json` and companion `Dockerfile` for evaluation runs.
- [x] dahuk.5 Add `examples/phase-eval/README.md` describing POC-spike status and usage.
- [x] dahuk.8 Add explicit Codespaces prebuild workflow trigger/wait/log capture path.
- [x] dahuk.9 Link deferred self-hosting runtime-adaptation follow-up to `TODO-fuviv.14`.
- [x] dahuk.10 Add durable phase markers to distinguish prebuild hook execution from first-boot hook execution.
- [x] dahuk.11 Add devcontainer CLI platform evaluation path (`--platform devcontainer`) and rename aggregate selector to `all`.
- [x] dahuk.12 Add `onCreate` hook evidence checks for all phase-eval platforms and expose `onCreate_seen` in run summary output.
- [x] dahuk.13 Fix prefixed log extraction and Codespaces phase bucketing for `onCreate` + add `user_nonempty` evidence fields.
- [x] dahuk.14 Promote `20260419T014758Z-3468588` as canonical evidence and refresh TODO-dahuk lifecycle/identity conclusions.
- [x] dahuk.6 Run phase-eval scenarios and record observed behavior summary in this TODO.
- [x] dahuk.7 Use observed results to drive decomk lifecycle redesign decisions (selector mapping + context axes).
