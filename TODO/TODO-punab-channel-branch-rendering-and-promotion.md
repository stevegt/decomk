# TODO-punab: channel branch rendering and promotion
...
Affects: `cmd/decomk/main.go`, `cmd/decomk/branch.go`, `cmd/decomk/branch_test.go`, `docs/thought-experiments/TE-jidus-branch-channel-renderer.md`, `TODO/TODO-punab-channel-branch-rendering-and-promotion.md`, `TODO/TODO.md`, downstream `.decomk/channels.json` registries.
...
- [x] punab.1 Run and record the branch-channel renderer thought experiment.
- [x] punab.2 Add the `decomk branch render` command surface.
- [x] punab.3 Add registry parsing, channel auto-detection, rendering, and stale-render checking.
- [x] punab.4 Add tests for channel rendering, `-check`, auto-detection, and `@latest` rejection.
- [ ] punab.5 Apply the registry to initial conf repos and use it in promotion workflows.
