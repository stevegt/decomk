# TODO-fuviv: decomk: migrate from Codespaces to DevPod on self-hosted GCP
...
Affects: `examples/decomk-selftest/devpod-local/*`, `TODO/TODO-fuviv-devpod-gcp-selfhost-migration.md`.
...
Affects: `TODO/TODO-fuviv-devpod-gcp-selfhost-migration.md`, `TODO/TODO.md`, future `examples/devpod/*`, future `infra/terraform/*`, `README.md`.
...
Affects: `examples/decomk-selftest/*`, `TODO/TODO-fuviv-devpod-gcp-selfhost-migration.md`, `README.md`.
Supersedes: DI-zoban (validation harness scope only)
...
Supersedes: DI-misov (harness orchestration implementation only)
...
Supersedes: DI-libor (selector naming only)
...
Supersedes: DI-visin (selector contract details)
...
Supersedes: DI-jidub (selftest execution plumbing)
...
Supersedes: DI-rujam (stage-0 bootstrap mechanics)
...
Affects: `examples/decomk-selftest/codespaces/run.sh`, `examples/decomk-selftest/codespaces/.devcontainer/*`, `examples/decomk-selftest/README.md`, `README.md`, `TODO/TODO-fuviv-devpod-gcp-selfhost-migration.md`.
...
Supersedes: DI-tihaj (config source requirement only)
...
Affects: `examples/decomk-selftest/codespaces/run.sh`, `.devcontainer/codespaces-selftest/devcontainer.json`, `.devcontainer/codespaces-selftest/Dockerfile`, `TODO/TODO-fuviv-devpod-gcp-selfhost-migration.md`.
Supersedes: DI-tihaj (devcontainer path + machine selection details only)
...
Affects: `examples/decomk-selftest/codespaces/run.sh`, `examples/decomk-selftest/README.md`, `README.md`, `TODO/TODO-fuviv-devpod-gcp-selfhost-migration.md`.
Supersedes: DI-hizim (machine defaulting behavior only)
...
Affects: `examples/decomk-selftest/codespaces/run.sh`, `README.md`, `TODO/TODO-fuviv-devpod-gcp-selfhost-migration.md`.
Supersedes: DI-monag (machine discovery mechanism only)
...
Affects: `examples/decomk-selftest/codespaces/run.sh`, `TODO/TODO-fuviv-devpod-gcp-selfhost-migration.md`.
...
Affects: `.devcontainer/codespaces-selftest/devcontainer.json`, `examples/decomk-selftest/codespaces/run.sh`, `TODO/TODO-fuviv-devpod-gcp-selfhost-migration.md`.
...
Affects: `Makefile`, `README.md`, `examples/decomk-selftest/README.md`, `TODO/TODO-fuviv-devpod-gcp-selfhost-migration.md`.
...
Affects: `TODO/TODO-fuviv-devpod-gcp-selfhost-migration.md`, `TODO/TODO-dahuk-phase-eval-lifecycle-spike.md`, future `examples/phase-eval/*`.

ID: DI-mutuk
Date: 2026-04-17 13:53:00
Status: active
Decision: Track image freeze/parity implementation in dedicated TODO-luvov and `doc/image-management.md`, while keeping TODO-fuviv focused on migration sequencing and provider/platform operations.
...
Constraints: Preserve TODO-fuviv migration phases and deferred GCP decisions; reference TODO-luvov as the source of truth for freeze/parity mechanics.
Affects: `TODO/TODO-fuviv-devpod-gcp-selfhost-migration.md`, `TODO/TODO-luvov-single-path-checkpoints.md`, `doc/image-management.md`, `TODO/TODO.md`.
...
Affects: `examples/decomk-selftest/fixtures/confrepo/Makefile`, `examples/decomk-selftest/devpod-local/run.sh`, `examples/decomk-selftest/codespaces/run.sh`, `TODO/TODO-fuviv-devpod-gcp-selfhost-migration.md`.
...
Implementation detail ownership: local freeze/parity mechanics, gates, and acceptance artifacts are tracked in TODO-luvov.

## Subtasks

- [ ] fuviv.1 Define Terraform root/module structure and environment variable contract.
- [ ] fuviv.2 Implement `network` module with VPC/subnet and outputs consumed by workspace modules.
- [ ] fuviv.3 Implement `iam` module with least-privilege roles for developers, CI, and workspace service accounts.
- [ ] fuviv.4 Implement `workspace_vm` module and document Docker runtime assumptions for DevPod.
- [ ] fuviv.5 Implement `observability` module for logs/metrics/budget labels and alerts.
- [ ] fuviv.6 Add `examples/devpod/` reference docs showing provider setup and `devpod up` flow.
- [ ] fuviv.7 Add migration runbook covering pilot, dual-run, cutover, and rollback.
- [x] fuviv.8 Define and automate local DevPod Docker-provider validation matrix in `examples/decomk-selftest/devpod-local` with decomk-native subtest orchestration.
- [ ] fuviv.9 Execute pilot cohort and capture parity findings vs Codespaces.
- [ ] fuviv.10 Perform default switch and keep rollback window open for one stabilization period.
- [ ] fuviv.11 Decommission Codespaces dependencies after stabilization and archive fallback documentation.
- [x] fuviv.12 Add automated Codespaces parity harness under `examples/decomk-selftest/codespaces`.
- [ ] fuviv.13 Revisit remote GCP-provider self-test scope after explicit move-to-GCP decision.
- [ ] fuviv.14 Evaluate deferred runtime-adaptation options for hook-inclusive prebuild snapshots (DevPod wrapper/fork vs reference-CLI wrapper) after baseline self-hosting cutover criteria are satisfied.
