# TODO-dajos: rendered devcontainer comment preservation
...
Affects: `cmd/decomk/branch.go`, `cmd/decomk/branch_test.go`, `TODO/TODO-dajos-rendered-devcontainer-comment-preservation.md`, `TODO/TODO.md`
...
Intent: Lock the concrete renderer strategy, naming family, and dependency update path so TODO-dajos can be implemented without inventing new code paths or layout policy mid-change.
...
Affects: `cmd/decomk/branch.go`, `cmd/decomk/branch_test.go`, `TODO/TODO-dajos-rendered-devcontainer-comment-preservation.md`, `go.mod`, `go.sum`
Supersedes: DI-kalih
...
Affects: `go.mod`, `TODO/TODO-dajos-rendered-devcontainer-comment-preservation.md`
...
`/home/stevegt/lab/decomk-conf-cswg` needs this so its channel registry can preserve the existing `DI-fiduv` rationale near the rendered `overrideCommand` field.
